...
from services.gemini_service import get_gemini_stream, parse_stream_chunks
    ...
    if prompt := st.chat_input("How can I help you?"):
        ...
        with st.chat_message("assistant"):
            try:
                ...
                raw_stream = get_gemini_stream(model_name, chat_history, prompt)
